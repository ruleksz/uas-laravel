...
<head>
    ...
    <title>Mahasiswa | Dashboard v2</title>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <a href="#" class="dropdown-item">
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('assets/dist/assets/img/prod-5.jpg') }}" alt="User Avatar"
                                            class="img-size-50 rounded-circle me-3" />
                                    </div>
                                    <div class="flex-grow-1">
                                        <h3 class="dropdown-item-title">
                ...
                <nav class="mt-2">
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item menu-open">
                            <a href="/admin/mahasiswa" class="nav-link active">
                        ...
                        <li class="nav-item menu-open">
                            <a href="{{ route('mahasiswa.mahasiswa.index') }}" class="nav-link active">
                                <i class="nav-icon bi bi-speedometer"></i>
                                <p>
                                    Data Mahasiswa
                                </p>
